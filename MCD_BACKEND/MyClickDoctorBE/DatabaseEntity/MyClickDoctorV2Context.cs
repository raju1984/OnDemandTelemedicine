...
{
    public partial class MyClickDoctorV4 : DbContext
    {
        public MyClickDoctorV4()
        {
        }

        public MyClickDoctorV4(DbContextOptions<MyClickDoctorV4> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<BannerList> BannerList { get; set; }
        public virtual DbSet<BannerRecord> BannerRecord { get; set; }
        public virtual DbSet<BannerStatus> BannerStatus { get; set; }
        ...
        public virtual DbSet<GroupMsgSeen> GroupMsgSeen { get; set; }
        ...
        public virtual DbSet<Myclickdoctor_Info> MyclickdoctorInfo { get; set; }
        ...
        public virtual DbSet<PatientBannerList> PatientBannerList { get; set; }
        ...
        public virtual DbSet<Pharmacompanyprojects> Pharmacompanyprojects { get; set; }
        public virtual DbSet<PharmaCompanyRepMap> PharmaCompanyRepMap { get; set; }
        public virtual DbSet<PharmaMaxConsultationCount> PharmaMaxConsultationCount { get; set; }
        ...
        public virtual DbSet<TempPharmaRepresentative> TempPharmaRepresentative { get; set; }
        ...
        // Unable to generate entity type for table 'dbo.Temp_Doctors'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Temp_Dates'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Temp_DurationCounts'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Temp_AvailForApp'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Temp_Appoinments'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
            optionsBuilder.UseSqlServer("Data Source=XXXXXXXX;Initial Catalog=TestMyClickDoctor; User ID = sa; Password = xxxxxxxxxx; Persist Security Info = True;Connect Timeout=30;Encrypt=False;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            //  }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BannerRecord>(entity =>
            {
            ...
            modelBuilder.Entity<Chat>(entity =>
            {
                ...
                entity.Property(e => e.Chatwith).HasMaxLength(50);
            ...
            modelBuilder.Entity<Currency>(entity =>
            {
                ...
                entity.Property(e => e.CurrencyName).HasMaxLength(550);
            });
            ...
            {
                entity.Property(e => e.DoctorType).HasMaxLength(50);
            ...
            modelBuilder.Entity<Doctors>(entity =>
            {
                ...
                entity.Property(e => e.DocCategory).HasMaxLength(50);
            ...
            modelBuilder.Entity<Myclickdoctor_Info>(entity =>
            {
                entity.ToTable("Myclickdoctor_Info");
            ...
            modelBuilder.Entity<PatientBannerList>(entity =>
            {
                entity.Property(e => e.FromDate).HasColumnType("datetime");
            ...
            modelBuilder.Entity<Payments>(entity =>
            {
                ...
                entity.Property(e => e.POSTransactionId).HasColumnName("POSTransactionId");
            ...
            modelBuilder.Entity<Reports>(entity =>
            {
                ...
                entity.Property(e => e.Specialty).HasMaxLength(250);

                entity.HasOne(d => d.Project)
                    .WithMany(p => p.Reports)
                    .HasForeignKey(d => d.ProjectId)
                    .HasConstraintName("FK_Reports_Projects");
            });
            ...
            modelBuilder.Entity<TempPharmaRepresentative>(entity =>
            {
                entity.ToTable("Temp_PharmaRepresentative");
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                ...
                entity.Property(e => e.EmailUpdatedAt).HasColumnType("datetime");
                ...
                entity.Property(e => e.SMSAuth).HasColumnName("SMSAuth");
